<div class="form-group {{ $errors->has('item_name') ? 'has-error' : ''}}">
    ...
    @foreach (json_decode('{"pcs":"Pieces","kg":"Kilograms","slice":"Slice"}', true) as $optionKey => $optionValue)
...
<div class="form-group {{ $errors->has('opening') ? 'has-error' : ''}}">
    <label for="opening" class="col-md-4 control-label">{{ 'Stock' }}</label>
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('sale') ? 'has-error' : ''}}">
    <label for="sale" class="col-md-4 control-label">{{ 'Selling Price' }}</label>
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('remarks') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <textarea name="remarks" cols="50" rows="5" id="remarks" value="{{ $item->remarks or ''}}">
